...
public class RedisKeyUtil {
    /** 根据 status 和 customerId 组装对应 Coupon 的 RedisKey */
    ...
    /** 根据 templateId 组装 Coupon Sn 集合 的 RedisKey */
    public static String getCouponSnListKeyByTemplateId(Integer templateId){
